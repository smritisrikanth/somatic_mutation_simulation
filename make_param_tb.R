...
param_tb$input_file = paste('sample_size_', param_tb$sample_size, '_', param_tb$sampling, '_', floor((as.numeric(rownames(param_tb))+2)/6), '.rda_', param_tb$mutation_rate, '_', param_tb$num_sim_2, '.rda', sep = "")
param_tb$input_file_original = paste('sample_size_', param_tb$sample_size, '_', param_tb$sampling, '_', floor((as.numeric(rownames(param_tb))+2)/6), '.rda', sep = "")
